...
sed -i "s|https.*/OpenWrt|https://github.com/ysx88/OpenWrt|g" package/luci-app-amlogic/root/etc/config/amlogic
# sed -i "s|http.*/library|https://github.com/ysx88/OpenWrt/backup/kernel|g" package/luci-app-amlogic/root/etc/config/amlogic
